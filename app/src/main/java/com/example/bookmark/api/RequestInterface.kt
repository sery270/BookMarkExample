...
interface RequestInterface {
    ...
    // 주어진 API는 GET 방식 통신인 것을 postman 실행 통해 파악
    // 과제의 요구사항인 paging 처리를 하려면, 아래 통신함수를 페이지 개수 만큼 만들거나, 동적으로 경로를 수정할 수 있어야한다고 생각함.
    // 위 방법 중 후자의 방법으로, @Path를 사용
    // @Path 는 동적으로 경로를 사용하기 위한 어노테이션 (retrofit2)
